...
class AdminProfileTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // Admin Avatar with gradient border (from Alex)
          Container(
          ...
          // Stats Cards Row (new feature from Alex)
          Row(
            children: [
              Expanded(
          ...
          // Profile info card (Corporate Modern - dev_josue base + Alex icon-row)
          Container(
  ...
  // New stat card widget from Alex
  ...
  // Enhanced credential row from Alex (with icon + optional badge)
