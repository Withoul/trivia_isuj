            ...
            if (!isEditing) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: _parseBannerColor(_colorBanner).withValues(alpha: 0.2),
                      blurRadius: 10,
                ...
                children: [
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      inactiveTrackColor: AppColors.primaryContainer.withValues(alpha: 0.15),
                ...
                children: [
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      inactiveTrackColor: AppColors.secondaryContainer.withValues(alpha: 0.15),
                      thumbColor: AppColors.secondaryContainer,
                      overlayColor: AppColors.secondaryContainer.withValues(alpha: 0.12),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  elevation: 4,
                  shadowColor: _parseBannerColor(_colorBanner).withValues(alpha: 0.3),
                ),
                child: _isLoading
  ...
  Widget _buildToggleCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: value ? activeColor.withValues(alpha: 0.3) : Colors.grey.shade200),
        boxShadow: [
          BoxShadow(
