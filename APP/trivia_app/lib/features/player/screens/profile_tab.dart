...
class ProfileTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return profileAsync.when(
      data: (user) {
        if (user == null) {
          return const Center(child: Text('No se pudo cargar el perfil del usuario.'));
        }

        final points = NumberFormat.decimalPattern().format(user.puntajeTotal ?? 0);
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: const CircleAvatar(
                        ...
                        child: Icon(Icons.person, color: AppColors.primaryContainer, size: 64),
                      ),
                    ),
                    Positioned(
                      bottom: -12,
                      child: Container(
                        ...
                        child: Text(
                          '⭐ NIVEL 12 - MAESTRO',
                          style: AppTextStyles.labelMd(color: AppColors.onSecondaryContainer).copyWith(
                            fontSize: 10,
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Quizzes Completados',
                              style: AppTextStyles.labelMd(color: AppColors.outline).copyWith(fontSize: 10, letterSpacing: 0),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            const Icon(Icons.local_fire_department, color: AppColors.streakOrange, size: 28),
                            const SizedBox(height: 8),
                            Text(
                              '${user.rachaMaxima ?? 0}',
                              style: AppTextStyles.scoreDisplay(color: AppColors.primaryContainer).copyWith(
                  ...
                  child: Row(
                    children: [
                      const CircleAvatar(
                        ...
                        child: Icon(Icons.diamond, color: AppColors.secondaryContainer),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Puntos Totales',
                              style: AppTextStyles.labelMd(color: AppColors.outline).copyWith(fontSize: 11, letterSpacing: 0),
                            ),
                            Text(
                              points,
                              style: AppTextStyles.scoreDisplay(color: AppColors.primaryContainer).copyWith(
                ...
                Row(
                  ...
                  children: [
                    _buildAchievementBadge('Mente Rápida', AppColors.secondaryContainer, Icons.flash_on, badgeCount: 3),
                    _buildAchievementBadge('Lector Feroz', Colors.purple.shade400, Icons.menu_book),
